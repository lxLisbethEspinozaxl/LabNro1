...
\begin{enumerate}[1.]
	...
	\begin{center}
	\includegraphics[width=11cm]{./Imagenes/actividad_03_01a} 
	...
	\\FROM employees AS emp; \\
	\begin{center}
	\includegraphics[width=15cm]{./Imagenes/actividad_03_02a}
	...
	FROM employees AS emp; \\
	\begin{center}
	\includegraphics[width=12cm]{./Imagenes/actividad_03_03a}
